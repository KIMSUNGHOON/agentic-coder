...
Use <think></think> tags to reason through your analysis. Consider these questions step-by-step:

<think>
**1. What is the user's PRIMARY GOAL?**
   - Are they seeking information or knowledge?
   - Do they want me to create/modify/review code?
...
**3. Does this require MULTI-STEP WORKFLOW?**
   ...
   - Can I answer this directly in a few sentences?
...
After your <think> reasoning, provide your analysis in JSON format:
...
<think>
User asks "how do I" - this is seeking knowledge/guidance, not requesting me to build it.
No explicit "create it for me" or "build me" command.
They want to learn the process, not get working code.
...
<think>
Direct action verb "Create" + technical deliverable specified.
User expects working code output, not just explanation.
This requires multi-step workflow: planning, implementation, testing.
Intent: coding_task
</think>
...
<think>
Starts with greeting but main intent is information request.
Focus on primary goal: the technical question.
No code output expected, just explanation.
Intent: simple_question (acknowledge greeting in response)
</think>
...
{{
    "intent": "simple_question",
    "requires_workflow": false,
    "direct_response": "Hi! REST uses fixed endpoints for each resource, while GraphQL lets clients request exactly the data they need in a single query. REST: multiple endpoints, GraphQL: single endpoint with flexible queries. Need more details?",
    "task_type": "question",
...
**Use your <think> reasoning to deeply understand user intent, not pattern matching.**
