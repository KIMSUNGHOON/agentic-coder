...
### ✅ Phase 1 - 긴급 개선 (완료: 2026-01-07)
- [x] 1. `dynamic_workflow.py` 수정
  - [x] 컨텍스트 윈도우: 6 → 20
  - [x] Truncate 한도: 200 → 1000
  - [x] State에 conversation_history 추가
- [x] 2. `state.py` 수정
  - [x] State에 conversation_history 필드 추가
  - [x] create_initial_state에 파라미터 추가
- [x] 3. `supervisor.py` 수정
  - [x] Harmony format 구조화 메서드 구현
  - [x] 컨텍스트 포맷팅 적용
- [x] 4. GPT-OSS Harmony Format 적용
  - [x] System prompt 구조화
  - [x] Context 타입 분리
  - [x] 구조화된 메시지 형식
