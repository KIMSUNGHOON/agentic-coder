            ...
            <div className="flex items-stretch gap-2">
              ...
              <div className="relative flex-1 min-w-0">
                <textarea
                  ...
                  disabled={isRunning}
                  rows={3}
                  className="w-full h-full px-3 py-2 pr-20 bg-gray-800 text-gray-100 placeholder-gray-500 rounded-lg text-sm font-mono focus:outline-none focus:ring-1 focus:ring-blue-500 border border-gray-700 disabled:opacity-50 resize-none overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800"
              ...
              <div className="flex items-center">
                <button
                  ...
                  className="p-2 h-[72px] rounded-md text-gray-500 hover:text-gray-300 hover:bg-gray-800 transition-colors flex items-center justify-center border border-gray-700"
